...
export const Button = ({ data, rows }: ButtonProps) => {
  ...
  useEffect(() => {
    setButtonData(data);
    data.couleur == 'bleu' ? setFillIcon('rgb(255,255,255,1)') : setFillIcon('rgb(0, 0, 145)');
  }, [data]);
  ...
  return (
    <>
        ...
        <div
          ...
          {buttonData.page_cible && (
            <Link
              ...
              target={buttonData.page_cible && buttonData.page_cible.includes('https://') ? '_blank' : undefined}
      ...
      {rows > 1 && (
        <div key={buttonData.id} style={{ marginBottom: marginsBottom[data.espacement_bas] }}>
          {buttonData.page_cible && (
            <Link
              href={buttonData.page_cible}
              target={buttonData.page_cible && buttonData.page_cible.includes('https://') ? '_blank' : undefined}
